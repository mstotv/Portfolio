...
export const TECH_STACK = [
  { name: 'Python', color: 'text-blue-400', bg: 'bg-blue-900/30' },
  { name: 'React', color: 'text-cyan-400', bg: 'bg-cyan-900/30' },
  { name: 'TypeScript', color: 'text-blue-500', bg: 'bg-blue-900/30' },
  { name: 'OpenAI', color: 'text-green-400', bg: 'bg-green-900/30' },
  { name: 'Meta', color: 'text-blue-300', bg: 'bg-blue-900/30' },
  { name: 'n8n', color: 'text-orange-400', bg: 'bg-orange-900/30' },
  { name: 'Tailwind CSS', color: 'text-teal-400', bg: 'bg-teal-900/30' },
  { name: 'Node.js', color: 'text-green-500', bg: 'bg-green-900/30' },
  { name: 'Vite', color: 'text-purple-400', bg: 'bg-purple-900/30' },
  { name: 'Framer Motion', color: 'text-pink-400', bg: 'bg-pink-900/30' },
  { name: 'WooCommerce', color: 'text-red-400', bg: 'bg-red-900/30' },
  { name: 'Google Cloud', color: 'text-yellow-400', bg: 'bg-yellow-900/30' },
];
