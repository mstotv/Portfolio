...
import NeonGlowBoxes from './components/NeonGlowBoxes';
...
function App() {
  ...
  const isRTL = dir === 'rtl';
  const fontClass = lang === 'en' ? 'font-mono' : 'font-arabic';
  ...
  return (
    <div className={`bg-black min-h-screen text-white ${fontClass} selection:bg-neon-red selection:text-white dir-${dir} relative`}>
      
      {/* Neon Glow Boxes Background */}
      ...
      {/* 3D Header with Sticky Effect */}
      <header className="fixed top-0 w-full z-40 bg-black/80 backdrop-blur-md border-b border-zinc-800 sticky-header">
      ...
      <footer className="bg-black border-t border-red-900/30 py-12">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4">
             <a href={SOCIAL_LINKS.instagramMain} className="text-gray-400 hover:text-neon-red transition-colors"><Instagram /></a>
             <a href="mailto:contact@mstotv.com" className="text-gray-400 hover:text-neon-red transition-colors"><Mail /></a>
          </div>
        </div>
      </footer>
