...
import { Service, Testimonial, PortfolioItem, UiTranslation, Language, ProfessionalPackage, FAQItem } from './types';
...
export const TRANSLATIONS: Record<Language, UiTranslation> = {
  ar: {
    ...
    sections: {
      ...
      faq_subtitle: 'إجابات على كل ما يدور في ذهنك حول خدماتنا.',
  ...
  ku: {
    ...
    sections: {
      ...
      faq_subtitle: 'وەڵام بۆ هەموو ئەو پرسیارانەی لە مێشکتدان.',
...
// Tech Stack Logos for Static Grid
...
export const getFAQs = (lang: Language): FAQItem[] => {
  ...
  return [
    {
      question: isEn ? "What is the difference between Business Starter and Ultimate Empire?" : isKu ? "جیاوازی نێوان پاکێجی دەستپێک و ئیمپایەر چییە؟" : "ما الفرق بين حزمة البداية والإمبراطورية؟",
      answer: isEn 
        ? "Business Starter includes all essential services (Website, E-commerce, Social Automation) but DOES NOT include the WhatsApp Automation system. The Ultimate Empire package includes EVERYTHING, plus the advanced WhatsApp AI system."
        : isKu
          ? "پاکێجی دەستپێک هەموو خزمەتگوزارییە سەرەکییەکان لەخۆدەگرێت (وێبسایت، فرۆشگا، ئۆتۆمەیشن) بەڵام سیستەمی واتسئەپی تێدا نییە. پاکێجی ئیمپایەر هەموو شتێکی تێدایە لەگەڵ سیستەمی زیرەکی واتسئەپ."
          : "حزمة البداية تشمل جميع الخدمات الأساسية (موقع، متجر، أتمتة انستغرام) ولكن لا تشمل نظام أتمتة واتساب. باقة الإمبراطورية تشمل كل شيء بالإضافة إلى نظام واتساب الذكي."
    },
    {
      question: isEn ? "Do I need technical skills to manage the automation?" : isKu ? "ئایا پێویستم بە شارەزایی تەکنیکی هەیە بۆ بەڕێوەبردنی ئۆتۆمەیشن؟" : "هل أحتاج لمهارات تقنية لإدارة الأتمتة؟",
      answer: isEn 
        ? "No! We build the entire system for you. You will receive a simple dashboard to manage orders and replies easily."
        : isKu
          ? "نەخێر! ئێمە تەواوی سیستەمەکەت بۆ دروست دەکەین. تۆ تەنها لوحەیەکی کۆنتڕۆڵی سادە وەردەگریت بۆ بەڕێوەبردنی داواکارییەکان."
          : "لا! نحن نبني لك النظام بالكامل. ستستلم لوحة تحكم بسيطة لإدارة الطلبات والردود بكل سهولة."
    },
    {
      question: isEn ? "How does the WhatsApp AI Bot work?" : isKu ? "بۆتی زیرەکی واتسئەپ چۆن کار دەکات؟" : "كيف يعمل بوت واتساب الذكي؟",
      answer: isEn 
        ? "The bot acts as a 24/7 employee. It understands customer queries, shows your menu/services, books appointments, and sends the final order details to you directly."
        : isKu
          ? "بۆتەکە وەک کارمەندێکی ٢٤ کاتژمێری کار دەکات. لە پرسیاری کڕیار تێدەگات، لیست و خزمەتگوزارییەکان پیشان دەدات، کات دیاری دەکات و داواکارییەکان بۆ تۆ دەنێرێت."
          : "البوت يعمل كموظف متاح 24 ساعة. يفهم استفسارات العملاء، يعرض القائمة/الخدمات، يحجز المواعيد، ويرسل لك تفاصيل الطلب النهائي مباشرة."
    },
    {
      question: isEn ? "What payment methods do you accept?" : isKu ? "ڕێگاکانی پارەدان چییە؟" : "ما هي طرق الدفع المقبولة؟",
      answer: isEn 
        ? "We accept Zain Cash, FIB, FastPay, USDT (Crypto), and Western Union."
        : isKu
          ? "ئێمە زین کاش، FIB، FastPay، USDT (کریپتۆ)، و وێستێرن یونیۆن وەردەگرین."
          : "نقبل الدفع عبر زين كاش، FIB، FastPay، USDT (العملات الرقمية)، و ويسترن يونيون."
    },
    {
      question: isEn ? "How long does it take to deliver the project?" : isKu ? "پڕۆژەکە چەند کاتی پێویستە؟" : "كم يستغرق تسليم المشروع؟",
      answer: isEn 
        ? "It depends on the package. Usually, Basic Automation takes 2-4 days, while full Websites and Ultimate Packages take 7-14 days."
        : isKu
          ? "بەپێی پاکێجەکە دەگۆڕێت. بە گشتی، ئۆتۆمەیشنی سەرەتایی ٢-٤ ڕۆژی دەوێت، وێبسایت و پاکێجی گەورە ٧-١٤ ڕۆژی دەوێت."
          : "يعتمد على الباقة. عادةً، الأتمتة الأساسية تستغرق 2-4 أيام، بينما المواقع الكاملة والباقات الشاملة تستغرق 7-14 يوماً."
    }
  ];
};
